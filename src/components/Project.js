  ...
  return (
    <section className="work">
      ...
      <div className="work-cards">
        {/* Check-Mate Card */}
        <div className="card" data-aos="fade-up" id="check-mate-card">
          <img
          ...
          <div className="card-body">
            ...
            <p className="card-text">
              Check-mate is a full-stack web application for keeping track of
              your expenses and setting smart savings goals. The application
              uses node.js, express.js, mySQL, and Sequelize to keep track of
              users, their transactions, and their budget goals on the back end
              and Chart.js, Bootstrap, and Handlebars to visualize every
        ...
        <div className="card" data-aos="fade-up" id="weather-dashboard-card">
          <img
          ...
          <div className="card-body">
            ...
            <p className="card-text">
              ...
              the user's inputted city and returns the current weather and
              weather outlook for a 5-day forecast. The application also
              utilizes local storage by saving the user's recently searched
              cities.
            </p>
            <a
          ...
          <div className="card-body">
            ...
            <p className="card-text">
              <div className="work-day-scheduler-body">
                ...
                makes use of the end user's local storage to save the events
                that are inputted.
              </div>
            </p>
            <a
          ...
          <div className="card-body">
            ...
            <p className="card-text">
              <div className="definehub-body">
                ...
                for styling along with Words API, YouTube API, LibreTranslate
                API, and SpeechSynthesis to provide the full user experience.
              </div>
              <ul>
                ...
                <li className="card-text">
                  YouTube API - Public API that passes the users inputted word
                  and selected language to build search parameters and displays
                  the returned video responses in an embedded player.
                </li>
                <li className="card-text">
          ...
          <div className="card-body">
            ...
            <p className="card-text">
              <div className="workoutTracker-body">
                ...
                view, create, and track daily workouts. The EU has the
                capability to log more than one exercise within a single workout
                and track each exercise's name, type, weight, sets, reps, and
                duration. If the exercise is cardio, the EU can track the
                distance traveled and duration as well.
                <br /> <br />
        ...
        {/* Note-Taker Card */}
        <div className="card" data-aos="fade-up" id="note-taker-card">
          <img
          ...
          <div className="card-body">
            ...
            <p className="card-text">
              The Note-Taker application utilizes Express.js back end to save
              and retrieve note data from a JSON file and displays it on the
              front end. This application also utilizes local storage to save
